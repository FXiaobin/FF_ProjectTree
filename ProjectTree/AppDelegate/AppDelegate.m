...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FFTabBarViewController *tabBarController = [[FFTabBarViewController alloc] init];
...
- (void)customizeNavigationBarAppearance {
    ...
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue-Light" size:18]}];
}
