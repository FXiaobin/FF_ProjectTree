...
/*边框的颜色*/
#define CROPVIEW_BOARDCOLOR     [UIColor orangeColor]
...
- (void)p_configAllViews {
    ...
    _containerView.layer.borderColor = CROPVIEW_BOARDCOLOR.CGColor;
    // 阴影
...
- (void)setScaleType:(CYCropScaleType)scaleType {
    ...
    switch (scaleType) {
        ...
        case CYCropScaleType1To2:
            mutiplyValue = 1.0/2.0;
            break;
        case CYCropScaleType2To1:
            mutiplyValue = 2.0/1.0;
            break;
